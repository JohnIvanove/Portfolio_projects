...
def get_weather():
    ...
    try:
        ...
        label['text'] = "Error retrieving weather data"
...
background_label = tk.Label(root, bg='light blue')
...
button = tk.Button(frame, text="Get Weather", bg="gray", fg="white", font=('Courier', 12), command=get_weather)
